...
def create_combined_efficiency_and_pt_plot(output_filename):
    # Set a visually informative color palette for 2D histograms
    ROOT.gStyle.SetPalette(ROOT.kBird)
    """
    Creates a canvas with multiple pads, plotting tracking efficiency,
    clone rate, fake rate, pT/eta distributions, and matching fraction vs pT.
    """
    ...
    # trackClassification values:
    # 0 = Unknown
    # 1 = Good/Matched track
    # 2 = Clone/Duplicate track
    # 3 = Fake track

    # Create a canvas with 12 pads (4 × 3 layout)
    ...
    # --- Third row: matching fraction ---
    # Pad 9: Matching Fraction vs. pT
    canvas.cd(9)
    ROOT.gPad.SetLeftMargin(0.15)
    ROOT.gPad.SetLogz()
